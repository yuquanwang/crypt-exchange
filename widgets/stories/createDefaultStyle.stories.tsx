...
import { Page, createDefaultStyle } from '../src'
...
export const Inputs = () => (
  <Book style={{ background: '#fff' }}>
    ...
    <label>
      颜色选择器：<input type='color' value={theme.colors.yellow} />
    </label>
    <label>
      日期：
    ...
    <label>
      滑动选择：<input type="range" id="cowbell" name="cowbell" min="0" max="100" value="90" step="10" />
    </label>
    <label>
